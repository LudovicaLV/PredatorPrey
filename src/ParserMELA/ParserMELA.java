...
public class ParserMELA implements MELAprog5Constants {
...
int xValue = Integer.parseInt(x.image);
  ...
  private boolean jj_3R_16()
 {
  ...
  public ParserMELA(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ParserMELA(java.io.InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public ParserMELA(java.io.Reader stream) {
  ...
  public ParserMELA(MELAprog5TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
